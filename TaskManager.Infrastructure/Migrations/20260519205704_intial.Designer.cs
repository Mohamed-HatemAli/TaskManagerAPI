...
namespace TaskManager.Infrastructure.Migrations
{
    ...
    [Migration("20260519205704_intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_Task_Management.Data.Entities.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2413312d-8caf-46a8-a3af-e1dfce568e41",
                            Email = "dev@taskmanager.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "DEV@TASKMANAGER.COM",
                            NormalizedUserName = "DEV_USER",
                            PasswordHash = "AQAAAAIAAYagAAAAEIPhtVG8bnCTK4ZM1plxmgr2+QScs5fOLvkpp4CnBw1y/w0EgQc/CKTaxvW5ePtYHw==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Project_Task_Management.Data.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Project_Task_Management.Data.Entities.Project", b =>
                {
                    b.HasOne("Project_Task_Management.Data.Entities.ApplicationUser", "User")
                        .WithMany("Projects")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
